...
class KnnDpmWpm:
    ...
    def get_f1_scores(self):
        ...
        #print(f1_scores)
        f1_dict = {}
        for idx, cat in enumerate(genres):
...
def generate_dataset_wpm_dpm():
    ...
    for dirpath, dirnames, filenames in os.walk("../NonImpairedSubtitles"):
        ...
        for index, filename in enumerate(files):
            ...
            if index/len(files)<0.9:
#            tmp = {'values': [dialog_per_minute, word_per_minute], 'labels': dirname, 'filename': filename, 'movie_times_minute': movie_time_minute}
