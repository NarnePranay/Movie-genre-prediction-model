...
filename = "D:/DMP/Movie-Category-Classification-from-Subtitles-master/Subtitles/Romance/Cast Away (IMPAIRED).srt"
...
#        prob=neigh.predict_proba(dataset['cv'][0])
#        print(len(prob[0]))
        
        #print(len(dataset['cv'][0]))
...
#    print(movie_length_mins,second_interval)
